...
for tm in date_range:
    ...
    df.loc[tm]['GWS'] = gws[0,idx_lat_cumilla,idx_lon_cumilla]
    
    df.loc[tm]['TWS'] = tws[0,idx_lat_cumilla,idx_lon_cumilla]
    
    df.loc[tm]['Evaporation'] = evap[0,idx_lat_cumilla,idx_lon_cumilla]
    
    df.loc[tm]['Short_Wave'] = shortwave[0,idx_lat_cumilla,idx_lon_cumilla]
...
df.to_csv('Gldas variable output.csv')
