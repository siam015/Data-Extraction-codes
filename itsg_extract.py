...
def date_to_string(srl_no):
    new_date = datetime.datetime(2016,1,1,0,0) + datetime.timedelta(srl_no)
    return new_date.strftime("%Y-%m-%d")


# read the data

data = Dataset('F:/ACADEMIC/WRE 4-1/Thesis/Soil_Moisture/Data/Grace_DAILY_Data/ITSG-Grace2018_daily_2016.nc','r')
...
df_TWSA.to_csv('GRACE_DAILY_TWSA_2016.csv')
